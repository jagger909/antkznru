    ...
    function get_schedulers() {
        ...
        $.ajax({
            ...
            beforeSend: function (xhr, settings) {
                ...
                //White cicle
                $('#date #calendar-box').append('<div id="loading-image"><img src="static/images/sched_wizard/ajax-loader.gif" alt="Loading..." /></div>');
            },

            complete: function() { $('.loading-image').remove();},
