...
if os.environ.get("DJANGO_SETTINGS_MODULE", None) == "antkznru.settings":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'test':
        logging.info("Module antkznru.settings is loading testing settings. Set DJANGO_SETTINGS_MODULE to override this.")
        from .testing import *
    else:  # pragma: no cover
        logging.info("Module antkznru.settings is loading development settings. Set DJANGO_SETTINGS_MODULE to override this.")
